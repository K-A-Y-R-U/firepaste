...
<head>
    ...
    <title>{{ __('¡Código Canjeado Exitosamente!') }}</title>
...
<body class="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-100 min-h-screen">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="text-center mb-8 celebration">
            ...
            <h1 class="text-4xl font-bold text-gray-800 mb-2">{{ __('¡Código Canjeado!') }}</h1>
            <p class="text-lg text-gray-600">{{ __('Tu membresía VIP ha sido activada') }}</p>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 border-l-4 border-green-500">
                <div class="text-center mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800 mb-2">
                        {{ __('¡Has recibido') }} {{ $vip_days }} {{ __('días de VIP!') }}
                    </h2>
                ...
                <div class="bg-gradient-to-r from-purple-100 to-blue-100 rounded-lg p-6 mb-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">{{ __('Detalles de tu membresía VIP') }}</h3>

                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600">{{ __('Estado:') }}</span>
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600">{{ __('Días añadidos:') }}</span>
                            <span class="font-semibold text-purple-600">{{ $vip_days }} {{ __('días') }}</span>
                        </div>

                        <div class="flex justify-between items-center">
                            <span class="text-gray-600">{{ __('Válido hasta:') }}</span>
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600">{{ __('Días restantes:') }}</span>
                            <span class="font-bold text-green-600">
                                {{ $vipStatus['days_remaining'] }} {{ __('días') }}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-6 mb-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">{{ __('Beneficios VIP activados') }}</h3>
                    <div class="grid grid-cols-1 gap-3">
                        <div class="flex items-center text-sm">
                            <svg class="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-gray-700">{{ __('Acceso a contenido VIP exclusivo') }}</span>
                        </div>
                        <div class="flex items-center text-sm">
                            <svg class="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-gray-700">{{ __('Descargas ilimitadas') }}</span>
                        </div>
                        <div class="flex items-center text-sm">
                            <svg class="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-gray-700">{{ __('Soporte prioritario') }}</span>
                        </div>
                        <div class="flex items-center text-sm">
                            <svg class="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-gray-700">{{ __('Sin publicidad') }}</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-lg mx-auto mt-6">
            <div class="bg-white rounded-lg shadow-md p-6">
                <h3 class="text-lg font-semibold text-gray-800 mb-4">{{ __('¿Tienes más códigos?') }}</h3>
                <p class="text-gray-600 mb-4">{{ __('Si tienes otro código de regalo, puedes canjearlo ahora mismo para extender tu membresía VIP.') }}</p>
